# Comet Automation Prompt for Encharge IMG Pivot Challenge Sequence

Copy the entire text below and paste into Comet's AI Assistant:

---

Task: Create a 7-email sequence in Encharge called "7-Day IMG Pivot Challenge"

1. Login to https://app.encharge.io

2. Go to Sequences → Create New Sequence
   - Name: "7-Day IMG Pivot Challenge"
   - Description: "Free 7-day email course for unmatched IMGs in Canada"

3. Add 7 emails with these exact details:
...
## EMAIL 4 (Send 24 hours after Email 3)
...
## EMAIL 5 (Send 24 hours after Email 4)
...
## EMAIL 6 (Send 24 hours after Email 5)
...
## EMAIL 7 (Send 24 hours after Email 6) — THE OFFER
...
4. After adding all 7 emails, configure:

Entry Trigger:
- Trigger Type: API / Manual Tag
- Trigger Tag: challenge-joined

Exit Action (after Email 7):
- Add Tag: challenge-complete

5. Save the sequence and copy the Sequence ID from the URL

6. Tell me when done with the Sequence ID
