"""
For each of the 16 April posts (LinkedIn+Facebook only):
1. Upload the matching Freepik image to Zernio
2. Delete the existing post
3. Recreate it with LinkedIn + Instagram + Facebook + image attached
"""
...
ASSETS = "/Users/toto/Claude TubeonAI/Freepik April"

# ── POST DATA ──────────────────────────────────────────────────────────────────
POSTS = [
    {
        "date": "2026-04-01",
        "old_id": "69c2ec2b5b76d4fc6d3936b5",
        "image": "freepik__cinematic-portrait-of-a-south-asian-man-in-his-40s__52542.jpeg",
        "title": "Origin Story",
...
#CrosswalkWisdom #NurseBurnoutRecovery #LeavingMedicine #HealthcareBurnoutSupport #CareerTransition #HealingJourney #NurseBurnout #BurnoutRecovery #HealthcareIdentityCrisis #MidlifeCareerChange #NurseTransition #NewChapter #BurnedOutNurse""",
...
Drop a crosswalk emoji in the comments if you've ever felt stuck between who you are and who you're supposed to be.""",
    ...
    {
        "date": "2026-04-05",
        "old_id": "69c2ec2f44bf467f6eb9d35d",
        "image": "freepik__a-pair-of-folded-blue-hospital-scrubs-resting-neat__52543.jpeg",
        "title": "Grief Post",
...
#HealthcareIdentityCrisis #NurseBurnoutRecovery #LeavingNursing #HealingFromBurnout #BurnoutRecovery #GriefAndLoss #NurseBurnout #CareerTransition #HealingJourney #MentalHealthMatters #CrosswalkWisdom #NurseTransition #LeavingMedicine""",
...
The crosswalk has room for your grief too. Bring it. We'll carry it together.""",
    ...
    {
        "date": "2026-04-06",
        "old_id": "69c2ec335b76d4fc6d3938f3",
        "image": "freepik__closeup-of-a-persons-hands-resting-on-an-open-lapt__52544.jpeg",
        "title": "AI as Bridge",
...
#AIforCareerChange #CareerTransition #NurseTransition #ChatGPT #ArtificialIntelligence #CareerChangeNurse #NurseBurnoutRecovery #CrosswalkWisdom #MidlifeCareerChange #HealthcareBurnoutSupport #NewChapter""",
...
Try it and report back.""",
    ...
    {
        "date": "2026-04-08",
        "old_id": "69c2ec375b76d4fc6d3939ca",
        "image": "freepik__closeup-of-a-pair-of-hands-gently-placing-a-hospit__52545.jpeg",
        "title": "Identity Loss Deep Dive",
...
If Identity Loss is your loudest fear, take the Fear Audit. 3 minutes. Completely free. Link in bio.

#FearAudit #HealthcareIdentityCrisis #NurseBurnoutRecovery #LeavingNursing #IdentityCrisis #CareerChangeNurse #NurseBurnout #BurnoutRecovery #CrosswalkWisdom #TheCrosswalkMethod #HealingJourney #NurseTransition #CareerTransition""",
...
The silence is the crosswalk. You're between two sides. And the only way through it is to keep walking.""",
    ...
    {
        "date": "2026-04-10",
        "old_id": "69c2ec3b5b76d4fc6d393a47",
        "image": "freepik__a-smartphone-with-a-cracked-screen-showing-a-text-__52546.jpeg",
...
#NurseBurnoutRecovery #LeavingNursing #HealthcareBurnoutSupport #FearOfJudgment #CareerChangeNurse #NurseBurnout #BurnoutRecovery #CrosswalkWisdom #FearAudit #NurseTransition #HealthcareIdentityCrisis #MentalHealthMatters""",
...
What's yours? Let's name them so they lose their power.""",
    ...
    {
        "date": "2026-04-11",
        "old_id": "69c2ec4044bf467f6eb9d453",
        "image": "freepik__a-city-pedestrian-traffic-signal-light-changing-fr__52547.jpeg",
        "title": "The Crosswalk Method",
...
#TheCrosswalkMethod #CrosswalkWisdom #NurseBurnoutRecovery #CareerTransition #HealingJourney #BurnoutRecovery #PersonalGrowth #NurseBurnout #HealthcareBurnoutSupport #LeavingMedicine #MidlifeCareerChange #NurseTransition""",
...
Where are you? Tell me in the comments. And if you're looking for your ELDER — that's literally why I'm here.""",
    ...
    {
        "date": "2026-04-12",
        "old_id": "69c2ec4344bf467f6eb9d4b7",
        "image": "freepik__soft-watercolor-wash-texture-in-warm-amber-and-cre__52548.jpeg",
...
#LeavingNursing #NurseBurnoutRecovery #HealthcareIdentityCrisis #BurnoutRecovery #HealingJourney #NurseBurnout #CareerTransition #LeavingMedicine #MentalHealthMatters #CrosswalkWisdom #NurseTransition #HealthcareBurnoutSupport #GriefAndHealing""",
        "facebook": """A former ICU nurse told me something last month that I can't stop thinking about:

"I don't miss the job. I miss who I was when I believed in it."

She wasn't nostalgic for the long shifts. She was nostalgic for the version of herself that believed the work mattered — before the system wore that belief down.
...
If you know a healthcare professional who has lost that fire — share this. Not as a fix. Just as a "you're not alone." """,
    ...
    {
        "date": "2026-04-15",
        "old_id": "69c2ec4744bf467f6eb9d578",
        "image": "freepik__a-clean-warm-flatlay-of-a-clipboard-with-a-white-n__52549.jpeg",
        "title": "5 AI Prompts",
...
#AIforCareerChange #CareerChangeNurse #NurseTransition #ChatGPTPrompts #CareerTransition #NurseBurnoutRecovery #CrosswalkWisdom #TransferableSkills #MidlifeCareerChange #HealthcareBurnoutSupport #ArtificialIntelligence #NewChapter""",
        "facebook": """Prompt of the Week challenge:

I'm sharing 5 AI prompts designed specifically for healthcare career changers.

Your challenge: Pick ONE. Use it this week. Come back and share what happened.

1. Resume Translator — turn clinical experience into business language
2. Cover Letter Coach — authentic story, not corporate fluff
3. Business Idea Generator — 10 ideas using your healthcare background
4. Reflection Journal — 5 deep questions about your transition
5. Interview Coach — prep for the career change question

No pressure to act on the results. This is just about seeing your skills through a different lens.

Who's in? Drop a hand-raise emoji below.""",
    },
    {
        "date": "2026-04-17",
        "old_id": "69c2ec4b44bf467f6eb9d624",
        "image": "freepik__interior-of-a-car-at-dusk-viewed-from-the-drivers-__52550.jpeg",
        "title": "Parking Lot Criers",
...
#NurseBurnout #BurnedOutNurse #NurseLife #HealthcareWorkerBurnout #NurseBurnoutRecovery #LeavingNursing #HealingFromBurnout #CrosswalkWisdom #HealthcareBurnoutSupport #NurseAdvocate #MentalHealthMatters #NurseTransition""",
...
What was your moment?""",
    ...
    {
        "date": "2026-04-19",
        "old_id": "69c2ec4f44bf467f6eb9d6ac",
        "image": "freepik__soft-cream-paper-texture-on-a-warm-white-backgroun__52551.jpeg",
        "title": "Self-Care Hot Take",
...
#NurseBurnout #SelfCare #HealthcareWorkerBurnout #BurnedOutNurse #NurseBurnoutRecovery #BurnoutRecovery #LeavingNursing #HealingJourney #CrosswalkWisdom #MentalHealthMatters #NurseLife #HealthcareBurnoutSupport #NurseAdvocate""",
        "facebook": """Real talk:
...
Real self-care sometimes looks like the scariest decision you've ever made.

Agree or disagree? Drop your take below.""",
    },
    {
        "date": "2026-04-20",
        "old_id": "69c2ec5344bf467f6eb9d716",
        "image": "freepik__a-person-sitting-alone-in-a-softly-lit-hospital-co__52553.jpeg",
        "title": "Burnout Assessment Tease",
...
2. You've stopped caring about the work — and the guilt of not caring is worse than the burnout itself.

3. Your body is keeping score. Migraines before shifts. Chest tightness in the parking lot. GI issues that no GI doc can explain.

4. You've fantasized about getting into a minor car accident on the way to work. Not to hurt yourself. Just to have a reason not to go in. If this is you — please hear me: this is a warning sign.

5. You can't remember the last time you felt proud of your work.
...
Something is coming that I think you need: The Burnout Crosswalk Assessment. Free. Launching soon. Link in bio to be first in line.

#NurseBurnout #BurnedOutNurse #NurseBurnoutRecovery #HealthcareWorkerBurnout #HealthcareBurnoutSupport #BurnoutRecovery #LeavingNursing #HealingFromBurnout #CrosswalkWisdom #MentalHealthMatters #NurseLife #NurseTransition #CareerChangeNurse""",
...
Because the middle is where you stop performing and start discovering.

Keep walking. The other side is one more step away. And it's been waiting for you longer than you know.

#HealingJourney #CrosswalkWisdom #NurseBurnoutRecovery #LeavingMedicine #CareerTransition #BurnoutRecovery #HealthcareIdentityCrisis #MentalHealthMatters #NurseBurnout #LeavingNursing #GriefAndHealing #TheCrosswalkMethod #NurseTransition""",
...
For eight months, I didn't have an answer.
...
If you're in the middle right now, drop a "walking" emoji below. I want to know you're here. And I want you to know you're not walking alone.""",
    ...
    {
        "date": "2026-04-24",
        "old_id": "69c2ec5b44bf467f6eb9d7f0",
        "image": "freepik__a-handwritten-letter-on-cream-textured-paper-lying__52555.jpeg",
        "title": "Letter to a Nurse",
...
If you need someone to talk to — someone who's been where you are and can tell you honestly what the other side looks like — my DMs are open.
...
#NurseBurnout #BurnedOutNurse #NurseLife #HealthcareWorkerBurnout #NurseBurnoutRecovery #LeavingNursing #NurseTransition #CareerChangeNurse #HealingFromBurnout #CrosswalkWisdom #NurseAdvocate #MentalHealthMatters #HealthcareBurnoutSupport""",
...
Welcome home.""",
    ...
    {
        "date": "2026-04-26",
        "old_id": "69c2ec5f44bf467f6eb9d869",
...
#HealingJourney #NurseBurnoutRecovery #LeavingNursing #LeavingMedicine #BurnoutRecovery #CrosswalkWisdom #HealthcareIdentityCrisis #MentalHealthMatters #NurseBurnout #CareerTransition #SelfCare #NurseTransition #HealingFromBurnout""",
        "facebook": """Sunday reflection:

You can hold the badge, the title, the years of training — and still set them down.

Holding something gently is not the same as gripping it tightly. And setting something down is not the same as throwing it away.

Most crossings are quiet. A slow exhale. A gentle loosening of the grip.

You don't have to drop everything all at once. You don't have to know what's next before you let go of what's now.

You just have to loosen your grip. One finger at a time.

The crosswalk will be there. Patient. Unhurried. Lit by a light that's been green for longer than you realize.""",
    },
    {
        "date": "2026-04-27",
        "old_id": "69c2ec645b76d4fc6d393c3c",
        "image": "freepik__a-persons-hands-typing-on-a-laptop-at-a-cozy-woode__52557.jpeg",
        "title": "AI Journaling",
...
#AIJournaling #CareerTransition #NurseTransition #ChatGPT #SelfReflection #NurseBurnoutRecovery #CrosswalkWisdom #HealthcareBurnoutSupport #MentalHealthMatters #BurnoutRecovery #HealingJourney #CareerChangeNurse""",
...
Who's in?""",
    ...
    {
        "date": "2026-04-29",
        "old_id": "69c2ec685b76d4fc6d393cf6",
        "image": "freepik__overhead-flatlay-of-a-warm-wooden-table-with-an-op__52558.jpeg",
...
#CrosswalkWisdom #TheCrosswalkMethod #NurseBurnoutRecovery #HealthcareBurnoutSupport #Community #HealingJourney #BurnoutRecovery #NurseBurnout #CareerTransition #Gratitude #NurseTransition #NurseLife""",
...
def upload_image(filepath):
    ...
    if not upload_url or not public_url:
        raise ValueError(f"Missing URLs in presign response: {data}")
...
def create_post(post, public_url):
    payload = {
        "content": post["linkedin"],
        "scheduledFor": f"{post['date']}T09:00:00",
        "timezone": TIMEZONE,
        "mediaItems": [{"url": public_url, "type": "image"}],
        "platforms": [
            {"platform": "linkedin",  "accountId": LINKEDIN_ID,  "customContent": post["linkedin"]},
            {"platform": "instagram", "accountId": INSTAGRAM_ID, "customContent": post["instagram"]},
            {"platform": "facebook",  "accountId": FACEBOOK_ID,  "customContent": post["facebook"]},
        ],
    }
...
if __name__ == "__main__":
    ...
    for post in POSTS:
        date  = post["date"]
        title = post["title"]
        img   = os.path.join(ASSETS, post["image"])

        # 1. Upload image
        try:
            public_url = upload_image(img)
            print(f"  [UPLOAD OK] {os.path.basename(img)}")
        except Exception as e:
            print(f"  [UPLOAD FAIL] {date} — {title}: {e}")
            continue

        # 2. Delete old post
        deleted = delete_post(post["old_id"])
        print(f"  [DELETE {'OK' if deleted else 'FAIL'}] {post['old_id']}")

        # 3. Recreate with image + Instagram
        status, result = create_post(post, public_url)
        if status in (200, 201):
            new_id = result.get("_id") or result.get("id", "?")
            print(f"  [POST OK {status}] {date} — {title} → {new_id}\n")
        else:
            print(f"  [POST FAIL {status}] {date} — {title}: {json.dumps(result)[:200]}\n")
